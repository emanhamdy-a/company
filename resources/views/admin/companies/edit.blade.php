              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="wepsite"
                   ...
                   value="@if(old('wepsite')) {{ old('wepsite') }}
                   @else {{$company->wepsite}} @endif"/>
                  @error('wepsite')
                    ...
                    <option value="0"
                      <?php
                        if(old('status') && old('status') ==='0'){
                          echo "selected";
                        }elseif($company->status==='0' && old('status')!='1'){
                          echo "selected";
                        }else{} ?> >Disabled
                    </option>
                    <option value="1"
                      ...
                      if(old('status') && old('status') =='1'){
                        echo "selected";
                      }elseif($company->status=='1' && old('status') !=='0'){
                        echo "selected";
                      }else{} ?> >Enabled
                    </option>
                  </select>
